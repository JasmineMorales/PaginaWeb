...
public class VentasService {
    ...
    //SERVICE PARA NOMBRES DE REPARTIDOR
    public Repartidor GetRepartidor(int id) {
        String url = "http://ec2-54-214-157-22.us-west-2.compute.amazonaws.com/api/v1.0/repartidor/" + id + "/";
        Repartidor response1 = restTemplate.getForObject(url, Repartidor.class);
        return response1;
    }
    //SERVICE PARA NOMBRES USUARIO
